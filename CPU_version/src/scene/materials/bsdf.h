...
public:
    ...
    // This is the inverse of worldToTangent
    // (incidentally, inverse(worldToTangent) = transpose(worldToTangent))
    ...
    // The ratio of indices of refraction at this surface point.
    // Irrelevant for opaque surfaces.
    float eta;
